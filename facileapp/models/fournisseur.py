...
class Fournisseur(BaseModel):
    ...
    d_list = {'action': [('Ajouter un fournisseur', 'Ajouter un fournisseur'),
                         ('Modifier un fournisseur', 'Modifier un fournisseur'),
                         ('Suprimer un fournisseur', 'Suprimer un fournisseur')]}

    l_index = [StringFields(title='Raison social', name='raison_social')]

    l_fields = [StringFields(title='contact (financier)', name='contact'),
